...
# sam2_checkpoint = f"./checkpoints/{model_version}/{model_version}_ti_1.pt"
# model_cfg = f"{model_version}/{model_version}_ti_1.yaml"
...
cap.set(cv2.CAP_PROP_FPS, 30)  # En lugar de 30
