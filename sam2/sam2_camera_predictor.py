...
from efficient_track_anything.modeling.efficienttam_base import  EfficientTAMBase as SAM2Base

from efficient_track_anything.modeling.efficienttam_base import NO_OBJ_SCORE  
# from sam2.utils.misc import concat_points, fill_holes_in_mask_scores, load_video_frames
from efficient_track_anything.utils.misc import concat_points, fill_holes_in_mask_scores, load_video_frames
import numpy as np
import cv2
...
class SAM2CameraPredictor(SAM2Base):
    ...
    def load_first_frame(self, img):
        ...
        self._get_image_feature(frame_idx=0, batch_size=10)
    ...
    def add_conditioning_frame(self, img):
        ...
        self._get_image_feature(
            frame_idx=self.condition_state["num_frames"] - 1, batch_size=10
        )
